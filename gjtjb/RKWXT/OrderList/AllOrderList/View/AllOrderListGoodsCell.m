...
@interface AllOrderListGoodsCell(){
...
@implementation AllOrderListGoodsCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        imgView = [[WXRemotionImgBtn alloc] initWithFrame:CGRectMake(xOffset, (AllOrderListGoodsCellHeight-imgHeight)/2, imgWidth, imgHeight)];
