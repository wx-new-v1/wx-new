...
@interface WaitReceiveOrderGoodsCell(){
...
@implementation WaitReceiveOrderGoodsCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        imgView = [[WXRemotionImgBtn alloc] initWithFrame:CGRectMake(xOffset, (WaitReceiveOrderGoodsCellHeight-imgHeight)/2, imgWidth, imgHeight)];
