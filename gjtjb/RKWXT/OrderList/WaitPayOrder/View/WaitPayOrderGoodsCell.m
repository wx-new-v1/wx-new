...
@interface WaitPayOrderGoodsCell(){
...
@implementation WaitPayOrderGoodsCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        imgView = [[WXRemotionImgBtn alloc] initWithFrame:CGRectMake(xOffset, (WaitPayOrderGoodsCellHeight-imgHeight)/2, imgWidth, imgHeight)];
