...
@interface OrderInfoOrderTimeCell(){
...
@implementation OrderInfoOrderTimeCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        CGFloat yGap = (OrderInfoOrderTimeCellHieght-4*labelHeight)/5;
