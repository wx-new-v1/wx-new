...
+(CGFloat)cellHeightOfInfo:(id)cellInfo{
    ...
    NSString *addressStr = [NSString stringWithFormat:@"%@%@%@%@",entity.proName,entity.cityName,entity.disName,entity.address];
    height = Ygap+[[self class] addressHeight:addressStr];
    return height;
}
